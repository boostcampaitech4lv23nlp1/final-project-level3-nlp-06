...
wandb_name="huggingface_apeach"
train_dir = "apeach.csv"
valid_dir = "apeach_test.csv"
batch_size = 32
epochs = 3
lr = 5e-5
save_step = 100
...
# Dataset
train_dataset = Apeach_Dataset(train_dir, model_name)
valid_dataset = Apeach_Dataset(valid_dir, model_name)
